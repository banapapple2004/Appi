...
let spotlightPromoContainer = document.querySelector(".spotlight > .produvt-promo");
createOfferlist(spotlightPromo, spotlightPromoContainer);

let healthArticleContainer = document.querySelector(".health-artcles > div");
